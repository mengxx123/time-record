            ...
            <div class="container" v-if="$store.state.user">
                ...
                <ul class="record-list">
                    <li class="item" v-for="item, index in objects" :key="index">
                        <router-link class="link" :to="`/locations/${item.id}`">
                            <div class="info">
                                <div class="name">
    ...
    export default {
                ...
                page: {
                    menu: [
                        ...
                        // },
                        {
                            type: 'icon',
                            icon: 'info',
                            href: 'https://project.yunser.com/products/2fe7c35062c811e99c8327d8a5d0b098',
                            target: '_blank',
                            title: '记录列表'
                        },
                    ]
        ...
        methods: {
            ...
            loadData() {
                ...
                // let { date } = this.$route.query
                this.$http.get(`/location_logs?keyword=${keyword ? encodeURIComponent(keyword) : ''}&page_size=9999`).then(
                    response => {
