...
<template>
    <my-page :title="title" :page="page" backable>
        <div class="common-container">
            <ui-text-field class="input" v-model="myObject.objectName" label="名称" />

            <br>
            <ui-text-field class="input" v-model="myObject.url" label="链接" />

            <br>
            <ui-text-field class="input" v-model="myObject.type" label="类型" />

            <br>
            <ui-text-field class="input" v-model="myObject.state" label="状态" />

            <br>
            <ui-text-field class="input" v-model="myObject.progress" label="进度" />
    ...
    export default {
        ...
        mounted() {
            ...
            if (id) {
                ...
                this.title = '修改物品'
                this.$http.get(`/read/logs/${id}`).then(
                    response => {
